...
3. Cohort retention curves (logo and revenue).
4. Revenue by channel and the share coming from founder-led sales.
5. Cap table (fully diluted), IP assignment status, prior financing docs.
6. Leadership org chart and named gaps.
7. Target close date and current pipeline of investor relationships, if any.
